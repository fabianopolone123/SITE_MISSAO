...
path('painel/prestacao-contas/', views.prestacao_contas, name='prestacao_contas'),
    ...
    path('painel/prestacao-contas/pdf/iniciar/', views.prestacao_contas_pdf_start, name='prestacao_contas_pdf_start'),
    path('painel/prestacao-contas/pdf/progresso/<int:job_id>/', views.prestacao_contas_pdf_progress, name='prestacao_contas_pdf_progress'),
    path('painel/prestacao-contas/pdf/arquivo/<int:job_id>/', views.prestacao_contas_pdf_file, name='prestacao_contas_pdf_file'),
